...
function createEnemyData(x, y, element) {
    ...
    switch(type) {
        case 'fast':
            enemyStats = { health: 30, speed: 3, damage: 15, points: 15, color: '#FF4500' };
            break;
        case 'tank':
            enemyStats = { health: 80, speed: 1, damage: 30, points: 25, color: '#2F4F4F' };
            break;
        default:
            enemyStats = { health: 50, speed: 1.5, damage: 20, points: 10, color: '#DC143C' };
    }
